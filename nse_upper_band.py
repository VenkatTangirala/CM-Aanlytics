...
#driver.get("https://www.zaubacorp.com/")
    ...
    columns=["Symbol","Series","LTP","Change","%Change","Price Band%","High","Low","52 WeekHigh","52 WeekLow","Volume in Shares","Value in Lacs.","View","Current Business Date"]
    df=pd.DataFrame()
    ...
    df.to_excel(writer,sheet_name='NSE UPPER BAND',columns=["Symbol","Series","LTP","Change","%Change","Price Band%","High","Low","52 WeekHigh","52 WeekLow","Volume in Shares","Value in Lacs.","View","Current Business Date"])
    writer.save()
    writer.close()
